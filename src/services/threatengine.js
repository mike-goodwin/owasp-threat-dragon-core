...
function threatengine() {
    ...
    function initialiseFlow(flowName) {
        return nools.flow(flowName, function (flow) {
            ...
            flow.rule('Least Privilege Violation', [[Element, 'el','(el.element.attributes.type == "tm.Process" && isTrue(el.element.privilegeLevelForProcess)) || (el.element.attributes.type ==  "tm.Actor" && isTrue(el.element.privilegeLevelForActor))|| (el.element.attributes.type == "tm.Store" && isTrue(el.element.privilegeLevelForStore))|| \n' +
            '(el.element.attributes.type == "tm.MobilePhone" && isTrue(el.element.privilegeLevelForMobilePhone)) || (el.element.attributes.type == "tm.Pacemaker" && isTrue(el.element.privilegeLevelForPacemaker)) || (el.element.attributes.type == "tm.SmartWatch" && isTrue(el.element.privilegeLevelForSmartWatch)) || (el.element.attributes.type == "tm.Laptop" && isTrue(el.element.privilegeLevelForLaptop)) || (el.element.attributes.type == "tm.Tablet" && isTrue(el.element.privilegeLevelForTablet)) || (el.element.attributes.type == "tm.Electrocardiogram" && isTrue(el.element.privilegeLevelForElectrocardiogram))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Insecure Randomness', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Insufficient Entropy', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Improper Certificate Validation', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Insufficient TLS Protection', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isFalse(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isFalse(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Hard-coded Cryptographic Key', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Insecure Compiler Optimization', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Insecure Transport', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Insufficient Session-ID Length', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Path Traversal', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Exposure of Private Information (Privacy Violation)', [[Element, 'el','(el.element.attributes.type == "tm.MobilePhone" && isTrue(el.element.storesMedicalRecords) || isTrue(el.element.storesPI))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Deserialization of Untrusted Data', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Improper Input Validation', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Missing XML Validation', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Overly Permissive Regular Expression', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Process Control', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Unchecked Return Value', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Unsafe use of reflection', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncrypted)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Session Variable Overloading', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Weak Server Side Controls', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Insecure Data Storage', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Insecure Authorization', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Insufficient Transport Layer Protection', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Unintended Data Leakage', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Client-Side Injection', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Poor Client Code Quality', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Code Tampering', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Reverse Engineering', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Security Decisions Via Untrusted Inputs', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Improper Session Handling', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncrypteStored))'],
                [Threats, 'threats']
            ], function (facts) {
            ...
            flow.rule('Lack of Binary Protections', [[Element, 'el','(el.element.attributes.type == "tm.Flow" && isTrue(el.element.isEncryptedFlow)) || (el.element.attributes.type == "tm.Store" && isTrue(el.element.isEncryptedStore))'],
                [Threats, 'threats']
            ], function (facts) {
